...
export interface JWT_CONFIG<T extends string = typeof DEFAULT_JWT_SECRET_ENV_NAME> {
    secretEnvName?: T;
    duration: string;
    tolerance?: string;
    algorithms: Array<string>;
}
export type JWTEnvVars<T extends string = typeof DEFAULT_JWT_SECRET_ENV_NAME> = Partial<Record<T, string>>;
/**
...
export type JWTServiceConfig<T extends string = typeof DEFAULT_JWT_SECRET_ENV_NAME> = {
    JWT_SECRET_ENV_NAME?: T;
    JWT: JWT_CONFIG<T>;
};
export type JWTServiceDependencies<T extends string = typeof DEFAULT_JWT_SECRET_ENV_NAME> = JWTServiceConfig<T> & {
    ENV?: JWTEnvVars<T>;
    time?: TimeService;
    log?: LogService;
};
export interface JWTServiceInitializer<PAYLOAD extends Record<string, unknown>, T extends string = typeof DEFAULT_JWT_SECRET_ENV_NAME> {
 ...
 */
declare function initJWT<PAYLOAD extends Record<string, unknown>, T extends string = typeof DEFAULT_JWT_SECRET_ENV_NAME>({ JWT_SECRET_ENV_NAME, ENV, JWT, time, log, }: JWTServiceDependencies<T>): Promise<JWTService<PAYLOAD>>;
